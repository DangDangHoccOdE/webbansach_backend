...
public interface OrderRepository extends JpaRepository<Order,Integer> {
    ...
    Page<Order> findByUser_UserIdAndDeliveryStatusContaining(@RequestParam("userId") Long userId, @RequestParam("deliveryStatus") String deliveryStatus, Pageable pageable);
